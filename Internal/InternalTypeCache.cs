...
namespace Cell.Cosmos.Internal
{
    internal class InternalTypeCache
    {
        ...
        internal ConstructorInfo FeedResponseCtorInfo<T>() => Type.GetType($"Microsoft.Azure.Documents.Client.FeedResponse`1{LibVersion}")
        ...
        internal static InternalTypeCache Instance
        {
            get
            {
                lock (Padlock)
                {
                    return _instance ??= new InternalTypeCache();
                }
            }
        }
